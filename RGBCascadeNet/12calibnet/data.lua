...
local sizelim=opt.TotNumberperLbl; -- size limit uppon training and test set per label
...
imageslist, imageslistt, crdnlty[{lbl,1}], crdnlty[{lbl,2}] = loadDataFiles('/home/jblan016/FaceDetection/dataset/data/croppednotdup/'..lbl..'/')-- TODO: 
	if lbl==1 then
