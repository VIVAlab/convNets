...
--threshold12Calib = cth/100
  local testLogger = optim.Logger('./logs12/12net_'..ich..'channels_12ct_Th'..'60'..'.log')
  detPred = {}
  detWin = {}
local IM12C={}
    ...
    --print(frame:size(1),frame:size(2),frame:size(3))
      ...
      if th>0 then
        for i=1,EffNScales do
          ...
          tempdets=applyCalibNet(calib12,IM12C[j],tempdets,FilterSize1,threshold12Calib,ich) 
