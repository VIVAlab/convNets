...
ich=3;
F3=importdata(sprintf('%s%d%s','20net_',ich,'channels_12ct_calib2Th45.log'));
...
ich=3;
F1=importdata(sprintf('%s%d%s','12netdeep_',ich,'channels_12ct_calib2Th35.log'));
