...
threshold12Calib = cth/100
  local testLogger = optim.Logger('./logs20/20net_'..ich..'channels_12ct_calib2Th'..cth..'.log')
  detPred = {}
  detWin = {}
local IM12C={}
    ...
    --print(frame:size(1),frame:size(2),frame:size(3))
      ...
      if cth>0 then
        for i=1,EffNScales do
          ...
          tempdets=applyCalibNet(calib12,IM12C[j],tempdets,FilterSize12net,threshold12Calib,ich) 
