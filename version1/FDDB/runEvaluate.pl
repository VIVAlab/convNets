...
my $GNUPLOT = "gnuplot"; 
# where the binary is
my $evaluateBin = "/home/mehdi/FDDB/evaluate"; 
# where the images are
my $imDir = "/home/mehdi/FDDB/facesInTheWild/"; 
# where the folds are
my $fddbDir = "/home/mehdi/FDDB/FDDB-folds"; 
# where the detections are
my $detDir = "/home/mehdi/FaceDetection2/model3Cascade/FDDB"; 
###########################
