...
for i,channel in ipairs(channels) do
   ...
   stdNEG[i] = trainDataNEG.data[{ {},i,{},{} }]:std()
   trainDataNEG.data[{ {},i,{},{} }]:add(-meanNEG[i])
   trainDataNEG.data[{ {},i,{},{} }]:div(stdNEG[i])
   meanPOS[i] = trainDataPOS.data[{ {},i,{},{} }]:mean()
   stdPOS[i] = trainDataPOS.data[{ {},i,{},{} }]:std()
   trainDataPOS.data[{ {},i,{},{} }]:add(-meanPOS[i])
   trainDataPOS.data[{ {},i,{},{} }]:div(stdPOS[i])
end
...
for i,channel in ipairs(channels) do
   ...
   meanTEST[i] = testData.data[{ {},i,{},{} }]:mean()
   stdTEST[i] = testData.data[{ {},i,{},{} }]:std() 

   testData.data[{ {},i,{},{} }]:add(-meanTEST[i])
   testData.data[{ {},i,{},{} }]:div(stdTEST[i])
end
...
for i,channel in ipairs(channels) do
   ...
   print('       negativetraining data, '..channel..'-channel, standard deviation: ' .. trainStdNEG)
