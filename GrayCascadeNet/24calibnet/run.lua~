...
opt = lapp[[
   -g,--optimization       (default 'sgd')       optimization method: ('sgd' or 'cg')
   -k,--maxIter            (default 3)           maximum iteration number for cg
   ...
   -l,--load               (default '')          directory to load previously saved model
   -n,--sizelim            (default 5e4)         size limit on training AND test set per class
